        ...
        <table className='border border-2 border-primary-subtle d-none d-md-block overflow-auto invoice-data-div py-2'>
            ...
            <tbody>
                ...
                (<tr key={index}>
                    ...
                    <td className='items-input-value'>
                        <InputField
                            className="text-start"
                            aria-label='Item Description'
                            type='text'
                            value={description}
                            onChange={(value) => handleDataChange('DESCRIPTION', value, index)}
                    ...
                    <td className='items-input-value'>
                        <InputField
                            ...
                            type='number'
                            value={quantity}
                            onChange={(value) => handleDataChange('QUANTITY', value, index)}
                            placeholder='1' />
                    </td>
                    ...
                    <td className='items-input-value'>
                        <InputField
                            ...
                            type='number'
                            value={rate}
                            onChange={(value) => handleDataChange('RATE', value, index)}
                            placeholder='0' />
                    </td>

                    <td className={`${isDataLength ? 'w-75' : 'w-100'} d-inline-block`}>
                        <InputField
                            className="border-0 w-100 bg-transparent"
                            type='number'
                            aria-label='Amount'
                            readOnly
                            value={amount?.toFixed(2)} /></td>
